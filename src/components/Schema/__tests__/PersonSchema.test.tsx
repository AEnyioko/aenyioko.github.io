...
describe('PersonSchema', () => {
  ...
  it('uses correct site URL from constants', () => {
    ...
    expect(data.image).toBe(`${SITE_URL}${PORTRAIT_IMAGE}`);
  });
  ...
  it('includes worksFor organization', () => {
    ...
    expect(data.worksFor.name).toBe('NeoGenomics Laboratories');
  });
  ...
  it('uses current role as job title', () => {
    ...
    expect(data.jobTitle).toBe('Accessioning Technician I');
  });
